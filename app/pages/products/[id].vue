<template>
	<div v-if="product">
		<Head>
			<Title>My Store - {{ product.title }}</Title>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
			...
			<div class="flex flex-col justify-center">
				<span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-2 py-1 rounded-full uppercase mb-3 self-start">{{ product.category }}</span>
				...
				<button class="w-full lg:w-auto bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors duration-300 flex items-center justify-center gap-2">
